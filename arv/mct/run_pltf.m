...
!/home/can/arastir/cuda2/cudainstall/4.1/cuda/bin/nvcc -c -g  mct_tensorop_utils.cu mct_tensorop_cpp.cu mct_tensorop_gpu.cu mct_kernels.cu mct.cu -arch sm_13 -Xcompiler -fPIC -I /home/can/bin/matlab_64/extern/include -I /home/can/arastir/cuda2/cudainstall/4.1/NVIDIA_GPU_Computing_SDK/C/common/inc/
