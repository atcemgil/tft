...
cmd = [ '/home/can/arastir/cuda2/cudainstall/4.1/cuda/bin/nvcc -c -g -G3' ...
        ...
        '-I common/ '...
        'common/tensorop_seq.cu common/tensorop_par.cu ' ...
        ' common/utils.cu '...
        ' common/kernels.cu ' ...
        'test/test_gmult.cu ' ...
      ]
...
display('linking test_gmult')
mex -cxx -largeArrayDims -o test_gmult ...
    utils.o ...
    tensorop_seq.o ...
    tensorop_par.o ...
    kernels.o ...
